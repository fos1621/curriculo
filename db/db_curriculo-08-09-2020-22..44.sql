...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Set-2020 às 03:43
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_salvar_habilidades` (IN `phabilidade` MEDIUMBLOB, IN `ptb_habilidadescol` MEDIUMBLOB, IN `vid_pessoa` INT)  NO SQL
BEGIN
...
CREATE TABLE `tb_habilidades` (
  ...
  `habilidade` mediumblob NOT NULL,
...
--
ALTER TABLE `tb_fone`
  MODIFY `id_fone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
