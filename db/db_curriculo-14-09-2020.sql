...
--
-- Host: 127.0.0.1
-- Generation Time: 14-Set-2020 às 13:49
...
(2, 'F', 'De Oliveveira Ferreira Santos', 'M', '1998-07-19', '2020-09-04 01:26:55', 2, 'Casado'),
...
(6, 'tamyviana15@gmail.com', '$2y$12$dc.N5u8k9qIQh3X5QhGVE.f.B9VoOM7bqp4EU9V27Hx00vRB0dR/i', '2020-09-14 02:12:11', 0, 1, 'tamires');
...
--
ALTER TABLE `tb_habilidades`
  MODIFY `id_habilidades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
