<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="wrapper">
	...
	<div class="bread">
		<div class="breadCrumb">
			<span> <i class="fa fa-home"></i> <a rel="nofollow" href="/criar-curriculo" title="Criar currículo">Criar currículo</a> <i class="fa fa-angle-double-right"></i> <span class="title-page">Dados Pessoais</span></span>
		</div>
	...
	<div class="cad-dados-pessoas">
		<form action="/dados-pessoais/up" method="post">
		  	...
		  	<div class="form-check">
	  			...
	  			<?php } ?>
		  	<label class="form-check-label" for="sexopessoa">
		    	Masculino
		  	</label>
			</div>
			<div class="form-check">
