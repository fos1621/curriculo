<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="wrapper">
	<div class="bread">
		<div class="breadCrumb">
			<span> <i class="fa fa-home"></i> <a rel="nofollow" href="/criar-curriculo" title="Criar currículo">Criar currículo</a> <i class="fa fa-angle-double-right"></i> <span class="title-page">Telefone</span></span>
		</div>
	...
	<div class="cad-dados-pessoas">
		<form action="/telefone-up" method="post">
		  	<div class="form-group">
			    <label for="ddd_fone">DDD</label>
			    <input type="text" class="form-control" value="<?php echo htmlspecialchars( $telefone["ddd_fone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="ddd_fone" name="ddd_fone" required autofocus>
		  	</div>
		  	<div class="form-group">
			    <label for="numero_fone">Celular ou Telefone </label>
			    <input type="text" class="form-control" value="<?php echo htmlspecialchars( $telefone["numero_fone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="numero_fone" name="numero_fone" required >
		  	</div>
		  	<!-- <div class="form-group">
